			...
			.formValidator(
				{
					validatorgroup: "2",
					tipid: "registerEmail",
					onshow: "填写后<font color='Red'>不能修改</font>",
					onfocus: "",
					oncorrect: ""
				})
			.inputValidator(
...
<form name="form1" 
      method="post" 
      action="<?php echo site_url('login/check_register')?>"
  ...
  <div class="mright">
	...
	<div class="lo_corner_c">
	  ...
	  <h2 class="login">
		...
		<span class="float_Right"></span><em>注册</em>
	  </h2>
	  ...
	  <div class="lo_child" style="width: auto; padding-right: 0pt;">
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮&nbsp;&nbsp;箱：
	    <input name="tbxRegisterEmail" maxlength="50" id="tbxRegisterEmail" type="text">&nbsp;
	    <div class="onShow" id="registerEmail">接收订单通知、促销活动、找回密码，填写后<font color="Red">不能修改</font></div>
	    <input name="RegisterEmail" id="RegisterEmail" type="hidden">
	  </div>
	  
	  
	  <div class="lo_child">
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;昵称：
	    <input name="tbxRegisterNickname" maxlength="20" id="tbxRegisterNickname" type="text">
		<div class="onShow" id="registerNickname">4-20位字符，可由中英文、数字及“_”、“-”组成</div>
		<input name="RegisterNickname" id="RegisterNickname" type="hidden">
	  </div>
	  
	  
	  <div class="lo_child">
		&nbsp;&nbsp;&nbsp;&nbsp;输入密码：
		<input name="tbxRegisterPassword" maxlength="16" id="tbxRegisterPassword" type="password">
		<div id="pwdStrengh" style="display: none;">密码强度：</div>
		<div class="onShow" id="registerPassword">6-16位字符，可由英文、数字及“_”、“-”组成</div>
		<input name="RegisterPassword" id="RegisterPassword" type="hidden">
	  </div>
	  
	  
	  <div class="lo_child">
	            再次输入密码：<input name="RegisterRepeatPassword" maxlength="16" id="RegisterRepeatPassword" type="password">
	  ...
	  <div class="lo_child yzm">
	     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;验证码：
	    <input name="tbxRegisterVerifier" 
	           maxlength="5"
	           id="tbxRegisterVerifier" 
	           autocomplete="off" 
	           type="text">
	    <div style="display: none;" id="registerVerifier"></div>
	    <div class="yzm_img" >
		  <img src="<?php echo site_url('login/yzm_img')?>" 
		       id="ivrRegisterVerifier" 
		       onclick="change_yzm(this)" />
		</div>
	  </div>
	  
	  <div class="lo_child align_Center">
	    <input id="choose" class="radio" checked="checked" type="checkbox">我已阅读并同意<a href="" target="_blank">《实现网服务条款》</a><div style="display: none;" id="agreement"></div>
	  </div>
	  
	  <div class="lo_submit">
	    <input name="ibtRegister" 
	           id="ibtRegister" 
	           src="<?php echo base_url()?>images/bottom_login.gif" 
	           onclick="return validate('2');WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ibtRegister&quot;, &quot;&quot;, true, &quot;2&quot;, &quot;&quot;, false, false))" 
